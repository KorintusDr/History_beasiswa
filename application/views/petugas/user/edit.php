                ...
                <div class="col-md-12">
                    <div class="card card-danger">
                        <div class="card-header">
                            <h3 class="card-title">Isi Formulir untuk Mengedit Data Pengguna</h3>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="nama_lengkap" name="nama_lengkap" value="<?= set_value('nama_lengkap', $user->nama_lengkap); ?>" required oninput="generateUsername()">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="password" class="form-control" id="password" name="password" placeholder="Masukkan password (kosongkan jika tidak diubah)">
                                                <div class="input-group-append">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="role" name="role" required>
                                                ...
                                                <?php foreach ($roles as $role): ?>
                                                    <option value="<?= $role->role; ?>" <?= ($user->role == $role->role) ? 'selected' : ''; ?>><?= ucfirst($role->role); ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="email" class="form-control" id="email" name="email" value="<?= set_value('email', $user->email); ?>" placeholder="Masukkan email" required>
                                            <?= form_error('email', '<small class="text-danger">', '</small>'); ?>
                                        </div>

                                        <div class="form-group">
                                            <label for="nomor_hp">Nomor HP</label>
                                            <input type="number" class="form-control" id="nomor_hp" name="nomor_hp" value="<?= set_value('nomor_hp', $user->nomor_hp); ?>" placeholder="Masukkan nomor HP" required>
                                            <?= form_error('nomor_hp', '<small class="text-danger">', '</small>'); ?>
                                        </div>

                                        <div class="form-group">
                                            <label for="alamat">Alamat</label>
                                            <textarea class="form-control" id="alamat" name="alamat" placeholder="Masukkan alamat" required><?= set_value('alamat', $user->alamat); ?></textarea>
